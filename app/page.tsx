...
export const metadata: Metadata = {
  title: 'ShantiSpace йога, фізична активність та оздоровчі рухові заняття Кривий Ріг',
  ...
  keywords: 'погодинна оренда залу, оздоровчі рухові заняття, функціональний рух, заняття для підтримки тіла, робота з поставою, формування правильно постави у дітей, групові заняття, індивідуальні заняття, Кривий Ріг, індивідуальний підхід, сучасні методи фізичної активності, покращення самопочуття, розвиток рухових навичок, йога, йогатерапія, цвяхостояння, жіноче коло, практика асан, вихід з негативу, чистий розум, консультації для військових',
  ...
  return (
    <section className="h-full -mx-[8px]">
      ...
      <ul>
        ...
        <li>
          <h3 className="mx-[20px] my-[20px] text-lg lg:text-xl 2xl:text-2xl">Рухова активність</h3>
          ...
          <p className="mx-[20px] my-[20px] text-md lg:text-xl 2xl:text-xl">Оздоровчі рухові заняття — це комплекс практик, спрямованих на підтримку та покращення функціональності тіла, розвиток рухливості, сили та координації, а також повернення комфорту у повсякденному русі.</p>
          <p className="mx-[20px] my-[20px] text-md lg:text-xl 2xl:text-xl">У нашому просторі заняття проходять у груповому та індивідуальному форматі та мають різну спрямованість — залежно від запиту, рівня підготовки та фізичних можливостей людини. Окремо діють заняття для дітей, спрямовані на формування правильної постави та здорових рухових звичок.</p>
          <p className="mx-[20px] my-[20px] text-md lg:text-xl 2xl:text-xl">У своїй роботі ми поєднуємо сучасні підходи до руху, практичні знання та уважне ставлення до тіла, створюючи безпечні та ефективні умови для занять.</p>
          <p className="mx-[20px] my-[20px] text-md lg:text-xl 2xl:text-xl">Регулярна рухова активність допомагає відновити баланс, впевненість у власних рухах та підтримувати активний спосіб життя, дозволяючи почуватися краще та повноцінно проживати кожен день.</p>
      ...
      <div className="lg:flex lg:items-center">
        ...
        <div className="lg:ml-4">
          ...
          <p className="mx-[20px] my-[20px] text-md lg:text-xl 2xl:text-xl">Стратегія для рухових занять та практик йоги адаптована до поточного стану здоров’я, фізичних можливостей та особистих цілей практикуючих.
