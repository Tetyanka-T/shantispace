    ...
    <section className="h-full -mx-[8px]">
      <div className={s.rent_hero}>
        <div className="text-center leading-7 text-2xl font-black tracking-wider">
          <h1 className="animate-fade-right animate-once animate-duration-[2000ms] animate-ease-in-out text-3xl text-amber-950 md:text-[36px] lg:text-[48px]">Погодинна оренда малого залу</h1>
