  ...
  return (
    <section className="h-full -mx-[8px]">
      ...
      <div className="my-0 md:grid md:grid-cols-2 md:gap-2 2xl:mx-60">
        ...
        <Image src="/LFK2.jpg" width={320} height={300} alt="Фізична реабілітація індивідуальне заняття" className="w-full h-500 object-contain" />
        <Image src="/LFK3.jpg" width={320} height={300} alt="Фізична реабілітація індивідуальне заняття" className="w-full h-auto object-contain" />
        <Image src="/LFK4.jpg" width={320} height={300} alt="Фізична реабілітація індивідуальне заняття" className="w-full h-auto object-contain" />
      </div>
