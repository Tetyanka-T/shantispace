    ...
    <section className="h-full -mx-[8px]">
      <div className={s.physical_hero}>
        <div className="text-center leading-7 text-2xl font-black tracking-wider">
          ...
          <Link href="tel:+380977339045" className="block w-[150px] rounded-md border-2 p-2 text-center text-lg border-amber-950 mx-auto mt-[20px] lg:w-[200px] lg:text-xl xl:mt-[40px]" aria-label="посилання на телефон для запису на фізичну реабілітацію">Записатись на заняття</Link>
        </div>
      </div>
      ...
      <h2 className="text-lg mx-3 my-2 lg:text-xl 2xl:text-2xl">В нашому центрі використання цього методу засновано на групових та індивідуальних заняттях в групах різної направленості по нозології.</h2>
      ...
      <h3 className="text-lg mx-6 my-2 md:mx-12 lg:text-xl 2xl:text-2xl">Індивідуальний підхід до кожного випадку, підбір оптимальних фізичних вправ та методів лікування, дозволяють досягти максимально ефективних результатів у відновленні.</h3>
      ...
      <div className="md:grid md:grid-cols-2 md:gap-2 md:my-4">
        <div className="my-4 md:my-0">
          <Image src="/couch.jpeg" alt="Дарина Полозок - інструктор з йоги, йогатерапевт та фізтерапевт" width={320} height={300} className="w-full mx-auto md:h-[500px] object-contain"/>
        ...
        <div className="mb-4 md:mb-0">
          <Image src="/svitlana.jpg" width={320} height={300} alt="Світлана Погребняк - інструктор з йоги та оздоровчої фізкультури" className="w-full mx-auto object-contain md:h-[500px]"/>
