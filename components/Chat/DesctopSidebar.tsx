...
const DesctopSidebar: React.FC<DesctopSidebarProps> = ({currentUser}) => {
  ...
  return (
    ...
    <SettingsModal currentUser={currentUser} isOpen={isOpen} onClose={() => setIsOpen(false)}/>
     <div className="hidden lg:absolute lg:inset-y-0 lg:left-0 lg:top-[90px] lg:z-40 lg:w-20 xl:px-6 lg:overflow-y-auto lg:bg-white lg:border-r-[1px] lg:pb-4 lg:flex lg:flex-col justify-between">
