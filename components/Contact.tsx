      ...
      <div className="md:grid md:grid-cols-2 my-10 2xl:text-2xl">
        <ul className="text-lg 2xl:text-xl">
          ...
          <li className="flex items-center">
            ...
            <p>великий зал - мк-рн. Ювілейний 11</p>
          </li>
          <li className="mt-3 h-300px">
            <Image src="/contact-large.jpg" alt="" width={320} height={350} className="w-full object-contain" />
          </li>
        </ul>
        <ul className="mt-10 md:mt-0 text-lg md:ml-10 2xl:text-xl">
          <li className="flex items-center mb-3">
            <MdOutlinePhoneIphone className="fill-amber-950 mr-2" />
          ...
          <li className="flex items-center">
            <CiLocationOn className="fill-amber-950 mr-2 mb-2" />
            <p>малий зал - мк-рн. Ювілейний 12</p>
          </li>
          <li className="mt-3 h-300px">
            <Image src="/contact-small.jpg" alt="" width={320} height={350} className="w-full object-cover" />
          </li>
        </ul>
      </div>
