...
const AnswerForm = ({ question }) => {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className='mx-auto flex flex-col justify-center items-center my-4 '
    >
      <textarea
      ...
      />
      <button className='shadow-xl shadow-neutral-500 rounded-md bg-amber-950 font-bold text-white py-3 px-6 w-fit mt-3'>
        Відповісти
      </button>
    </form>
  )
