    ...
    <div className="mx-auto pt-4">
      <div className="min-[1500px]:flex items-center">
        ...
        <div className="my-2 text-lg font-normal tracking-normal leading-6 md:ml-4">
          ...
          <p className="mt-2">Запрошую вас на подорож до здоров'я вашого тіла та покращення його функціональності. </p>
          ...
          <p className="mt-2">Консультую та розроблюю індивідуальні програми в роботі з<strong> військовими</strong>.
          </p>
          ...
          <p className="mt-2">Працюю <strong>з підлітками</strong> в групі формування правильної постави або індивідуально! Заняття направлене на формування правильної постави через комплекси корекційних вправ для м&apos;язів спини, стопи, преса тощо.</p>
          <p className="mt-2">Моя робота не в лікуванні, а в попередженні захворювань та створенні здорового стилю життя та щоденної рухової активності, підібраної індивідуально саме для вас.</p>
          <p className="mt-2">
           Завжди відкрита до нових викликів і готова поділитися своїми знаннями і досвідом. Якщо у вас є які-небудь питання або ви хочете розпочати свій шлях до фізичного здоров'я, приєднуйтеся до простору <a href="/register" target="_blank" className="border-b-2 border-amber-950">ShantiSpace</a> та {isAuth ? (<a href="/questions/addquestion" target="_blank" className="border-b-2 border-amber-950"><strong>напишіть мені!</strong></a>) : (<a href="/register" target="_blank" className="border-b-2 border-amber-950"><strong>напишіть мені!</strong></a>)}
          </p>
