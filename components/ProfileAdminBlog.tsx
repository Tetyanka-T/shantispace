  ...
  return (
    <div className="mx-auto pt-4">
      <div className="min-[1500px]:flex items-center">
        <Image src="/profile-admin.jpg" alt="Дарина Полозок" width={320} height={200} className="mx-auto md:w-96"/>
        <div className="my-2 text-lg font-normal tracking-normal leading-6 md:ml-4">
         ...
         <p className="mt-2">Чи ви новачок в йозі чи давно їй віддані, я завжди тут, щоб поділитися знаннями та створити простір для вашого самовдосконалення.
            Я можу допомогти вам відчувати себе краще кожен день.</p>
         <p className="mt-2">
          Впевнена, що кожен з нас може знайти в собі справжній потенціал для внутрішнього росту та здоров&apos;я через єдине - <strong>свідоме об&apos;єднання руху, дихання та медитації.</strong>
        </p>
